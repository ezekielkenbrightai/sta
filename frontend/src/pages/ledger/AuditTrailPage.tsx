...
const MOCK_AUDIT: AuditEntry[] = [
  ...
  { id: 'aud-011', timestamp: '2026-02-21 16:50:44', user: 'System', user_role: 'system', action: 'create', entity_type: 'payment', entity_ref: 'PAY-2026-0184', description: 'CBDC payment processed: TZS 31,200 for Dar es Salaam Freight', ip_address: '10.0.1.1', hash: '4e6f8a2c' },
