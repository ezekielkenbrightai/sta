...
const MOCK_DOC = {
  ...
  items: [
    { id: 'ti-1', hs_code: '8471.30', description: 'Portable digital computers (laptops)', quantity: 500, unit: 'pcs', unit_value: 350, total_value: 175000, origin_country: 'Nigeria', duty_rate: 0 },
    { id: 'ti-2', hs_code: '6109.10', description: 'T-shirts, cotton', quantity: 2000, unit: 'pcs', unit_value: 15, total_value: 30000, origin_country: 'Nigeria', duty_rate: 35 },
    { id: 'ti-3', hs_code: '8703.23', description: 'Motor vehicle spare parts', quantity: 100, unit: 'pcs', unit_value: 400, total_value: 40000, origin_country: 'Nigeria', duty_rate: 25 },
  ],
  tax_assessment: {
    customs_duty: 27500,
    vat: 43520,
