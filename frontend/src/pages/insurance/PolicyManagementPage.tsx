...
const MOCK_POLICIES: InsurancePolicy[] = [
  { id: 'pol-001', reference: 'POL-2026-MC-0421', trader: 'Kenya Pharma Distributors', type: 'marine_cargo', provider: 'APA Insurance', coverage_usd: 250000, premium_usd: 3750, deductible_usd: 5000, status: 'claim_active', start_date: '2026-01-15', end_date: '2026-07-15', trade_doc_ref: 'TD-2026-1842', route: 'Dar es Salaam → Mombasa', claims_count: 1 },
  ...
  { id: 'pol-003', reference: 'POL-2026-MC-0398', trader: 'Lagos Electronics Ltd', type: 'marine_cargo', provider: 'Britam Insurance', coverage_usd: 800000, premium_usd: 16000, deductible_usd: 15000, status: 'active', start_date: '2026-02-01', end_date: '2026-08-01', trade_doc_ref: 'TD-2026-1838', route: 'Lagos → Mombasa', claims_count: 1 },
  ...
  { id: 'pol-006', reference: 'POL-2026-TC-0178', trader: 'Addis Pharmaceutical', type: 'trade_credit', provider: 'Jubilee Insurance', coverage_usd: 300000, premium_usd: 7500, deductible_usd: 6000, status: 'active', start_date: '2026-01-15', end_date: '2026-07-15', trade_doc_ref: 'TD-2026-1837', route: 'Cape Town → Mombasa → Addis', claims_count: 1 },
  ...
  { id: 'pol-009', reference: 'POL-2026-MC-0430', trader: 'Dar es Salaam Freight', type: 'marine_cargo', provider: 'Britam Insurance', coverage_usd: 600000, premium_usd: 12000, deductible_usd: 12000, status: 'pending', start_date: '2026-02-25', end_date: '2026-08-25', trade_doc_ref: 'TD-2026-1850', route: 'Cairo → Mombasa → Dar', claims_count: 0 },
];
