...
const MOCK_QUEUE: ClearanceItem[] = [
  { id: 'cq-001', reference: 'CUS-2026-5421', trade_doc_ref: 'TD-2026-1842', trader: 'Kenya Pharma Distributors', type: 'import', origin_country: 'Ghana', dest_country: 'Kenya', hs_codes: ['3004.90', '3003.20'], declared_value_kes: 4850000, duty_assessed_kes: 485000, status: 'cleared', risk_level: 'green', assigned_officer: 'Jane Mwangi', submitted_at: '2026-02-22 09:15', port_of_entry: 'JKIA Air Cargo', items_count: 50, containers: 2 },
  ...
  { id: 'cq-003', reference: 'CUS-2026-5419', trade_doc_ref: 'TD-2026-1840', trader: 'East Africa Cement Ltd', type: 'import', origin_country: 'Nigeria', dest_country: 'Kenya', hs_codes: ['2523.29', '7213.10'], declared_value_kes: 36000000, duty_assessed_kes: 9000000, status: 'pending_inspection', risk_level: 'yellow', assigned_officer: null, submitted_at: '2026-02-22 07:30', port_of_entry: 'Mombasa Port', items_count: 120, containers: 8 },
  ...
  { id: 'cq-005', reference: 'CUS-2026-5417', trade_doc_ref: 'TD-2026-1838', trader: 'Lagos Electronics Ltd', type: 'import', origin_country: 'Morocco', dest_country: 'Kenya', hs_codes: ['8517.12', '8471.49'], declared_value_kes: 22000000, duty_assessed_kes: 5500000, status: 'risk_assessed', risk_level: 'red', assigned_officer: 'David Maina', submitted_at: '2026-02-21 16:00', port_of_entry: 'JKIA Air Cargo', items_count: 80, containers: 3 },
  { id: 'cq-006', reference: 'CUS-2026-5416', trade_doc_ref: 'TD-2026-1837', trader: 'Addis Pharmaceutical', type: 'import', origin_country: 'South Africa', dest_country: 'Ethiopia', hs_codes: ['3004.50'], declared_value_kes: 7200000, duty_assessed_kes: 360000, status: 'payment_pending', risk_level: 'green', assigned_officer: 'Jane Mwangi', submitted_at: '2026-02-21 14:30', port_of_entry: 'Mombasa Port', items_count: 25, containers: 1 },
  { id: 'cq-007', reference: 'CUS-2026-5415', trade_doc_ref: 'TD-2026-1836', trader: 'Nairobi Fashion House', type: 'import', origin_country: 'Tunisia', dest_country: 'Kenya', hs_codes: ['6204.23', '6109.10'], declared_value_kes: 3200000, duty_assessed_kes: 800000, status: 'inspection_complete', risk_level: 'yellow', assigned_officer: 'Grace Njeri', submitted_at: '2026-02-21 11:00', port_of_entry: 'JKIA Air Cargo', items_count: 300, containers: 2 },
