...
const VESSEL_ACTIVITY: VesselActivity[] = [
  ...
  { id: 'va-005', vessel_name: 'ET 721', type: 'aircraft', flag: 'Ethiopia', port: 'JKIA Air Cargo', berth_terminal: 'Gate 5B', status: 'departed', eta_etd: 'Departed 2026-02-22 11:45', cargo_type: 'Cut flowers — export to South Africa', containers: 12, tonnage: 38, agent: 'Ethiopian Cargo Services' },
  { id: 'va-006', vessel_name: 'MV Zanzibar Pearl', type: 'container_ship', flag: 'Tanzania', port: 'Mombasa Port', berth_terminal: '—', status: 'approaching', eta_etd: 'ETA 2026-02-22 18:00', cargo_type: 'Automobiles, machinery', containers: 180, tonnage: 32000, agent: 'Maersk Kenya' },
